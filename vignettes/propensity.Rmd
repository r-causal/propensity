...
For continuous exposures, weights use density ratios. These are stabilized by
default, since the unstabilized ratio carries the exposure's own units and has
a heavy right tail; pass `stabilize = FALSE` to turn that off:
...
# Stabilized weights, which is what a continuous exposure gets by default
